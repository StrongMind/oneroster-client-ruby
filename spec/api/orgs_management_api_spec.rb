...
# Unit tests for OneRosterClient::OrgsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrgsManagementApi' do
  before do
    # run before each test
    @instance = OneRosterClient::OrgsManagementApi.new
  end
  ...
  describe 'test an instance of OrgsManagementApi' do
    it 'should create an instance of OrgsManagementApi' do
      expect(@instance).to be_instance_of(OneRosterClient::OrgsManagementApi)
    end
  end
