...
# Unit tests for OneRosterClient::EnrollmentTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EnrollmentTypeAllOf' do
  before do
    # run before each test
    @instance = OneRosterClient::EnrollmentTypeAllOf.new
  end
  ...
  describe 'test an instance of EnrollmentTypeAllOf' do
    it 'should create an instance of EnrollmentTypeAllOf' do
      expect(@instance).to be_instance_of(OneRosterClient::EnrollmentTypeAllOf)
    end
  end
