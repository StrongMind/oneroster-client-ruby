...
# Unit tests for SwaggerClient::ResultsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultsManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ResultsManagementApi.new
  end
  ...
  describe 'test an instance of ResultsManagementApi' do
    it 'should create an instance of ResultsManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ResultsManagementApi)
    end
  end
