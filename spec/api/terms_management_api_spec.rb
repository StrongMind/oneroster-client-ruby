...
# Unit tests for SwaggerClient::TermsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TermsManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::TermsManagementApi.new
  end
  ...
  describe 'test an instance of TermsManagementApi' do
    it 'should create an instance of TermsManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::TermsManagementApi)
    end
  end
