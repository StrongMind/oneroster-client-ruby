...
module OneRosterClient
  class UsersManagementApi
    ...
    def get_user(sourced_id, opts = {})
      data, _status_code, _headers = get_user_with_http_info(sourced_id, opts)
      data
    end
    ...
    def get_user_with_http_info(sourced_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersManagementApi.get_user ...'
      end
      # verify the required parameter 'sourced_id' is set
      if @api_client.config.client_side_validation && sourced_id.nil?
        fail ArgumentError, "Missing the required parameter 'sourced_id' when calling UsersManagementApi.get_user"
      end
      # resource path
      local_var_path = '/users/{sourcedId}'.sub('{' + 'sourcedId' + '}', sourced_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersManagementApi#get_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_users_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersManagementApi.get_users ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersManagementApi#get_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
