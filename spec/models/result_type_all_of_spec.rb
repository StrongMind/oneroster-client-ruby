...
# Unit tests for OneRosterClient::ResultTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultTypeAllOf' do
  before do
    # run before each test
    @instance = OneRosterClient::ResultTypeAllOf.new
  end
  ...
  describe 'test an instance of ResultTypeAllOf' do
    it 'should create an instance of ResultTypeAllOf' do
      expect(@instance).to be_instance_of(OneRosterClient::ResultTypeAllOf)
    end
  end
