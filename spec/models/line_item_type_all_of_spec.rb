...
# Unit tests for SwaggerClient::LineItemTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LineItemTypeAllOf' do
  before do
    # run before each test
    @instance = SwaggerClient::LineItemTypeAllOf.new
  end
  ...
  describe 'test an instance of LineItemTypeAllOf' do
    it 'should create an instance of LineItemTypeAllOf' do
      expect(@instance).to be_instance_of(SwaggerClient::LineItemTypeAllOf)
    end
  end
