...
# Unit tests for OneRosterClient::AcademicSessionTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcademicSessionTypeAllOf' do
  before do
    # run before each test
    @instance = OneRosterClient::AcademicSessionTypeAllOf.new
  end
  ...
  describe 'test an instance of AcademicSessionTypeAllOf' do
    it 'should create an instance of AcademicSessionTypeAllOf' do
      expect(@instance).to be_instance_of(OneRosterClient::AcademicSessionTypeAllOf)
    end
  end
