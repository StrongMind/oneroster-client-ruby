...
# Unit tests for OneRosterClient::LineItemsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LineItemsManagementApi' do
  before do
    # run before each test
    @instance = OneRosterClient::LineItemsManagementApi.new
  end
  ...
  describe 'test an instance of LineItemsManagementApi' do
    it 'should create an instance of LineItemsManagementApi' do
      expect(@instance).to be_instance_of(OneRosterClient::LineItemsManagementApi)
    end
  end
