...
# Unit tests for SwaggerClient::CategoriesManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CategoriesManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CategoriesManagementApi.new
  end
  ...
  describe 'test an instance of CategoriesManagementApi' do
    it 'should create an instance of CategoriesManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CategoriesManagementApi)
    end
  end
