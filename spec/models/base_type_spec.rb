...
# Unit tests for OneRosterClient::BaseType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BaseType' do
  before do
    # run before each test
    @instance = OneRosterClient::BaseType.new
  end
  ...
  describe 'test an instance of BaseType' do
    it 'should create an instance of BaseType' do
      expect(@instance).to be_instance_of(OneRosterClient::BaseType)
    end
  end
