...
# Unit tests for OneRosterClient::CourseTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CourseTypeAllOf' do
  before do
    # run before each test
    @instance = OneRosterClient::CourseTypeAllOf.new
  end
  ...
  describe 'test an instance of CourseTypeAllOf' do
    it 'should create an instance of CourseTypeAllOf' do
      expect(@instance).to be_instance_of(OneRosterClient::CourseTypeAllOf)
    end
  end
