...
# Unit tests for SwaggerClient::CoursesManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoursesManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CoursesManagementApi.new
  end
  ...
  describe 'test an instance of CoursesManagementApi' do
    it 'should create an instance of CoursesManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CoursesManagementApi)
    end
  end
