...
module OneRosterClient
  class OrgsManagementApi
    ...
    def get_org(sourced_id, opts = {})
      data, _status_code, _headers = get_org_with_http_info(sourced_id, opts)
      data
    end
    ...
    def get_org_with_http_info(sourced_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrgsManagementApi.get_org ...'
      end
      # verify the required parameter 'sourced_id' is set
      if @api_client.config.client_side_validation && sourced_id.nil?
        fail ArgumentError, "Missing the required parameter 'sourced_id' when calling OrgsManagementApi.get_org"
      end
      # resource path
      local_var_path = '/orgs/{sourcedId}'.sub('{' + 'sourcedId' + '}', sourced_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrgsManagementApi#get_org\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_orgs_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrgsManagementApi.get_orgs ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrgsManagementApi#get_orgs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
