...
module SwaggerClient
  class GradingPeriodsManagementApi
    ...
    def get_grading_period(sourced_id, opts = {})
      data, _status_code, _headers = get_grading_period_with_http_info(sourced_id, opts)
      data
    end
    ...
    def get_grading_period_with_http_info(sourced_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GradingPeriodsManagementApi.get_grading_period ...'
      end
      # verify the required parameter 'sourced_id' is set
      if @api_client.config.client_side_validation && sourced_id.nil?
        fail ArgumentError, "Missing the required parameter 'sourced_id' when calling GradingPeriodsManagementApi.get_grading_period"
      end
      # resource path
      local_var_path = '/gradingPeriods/{sourcedId}'.sub('{' + 'sourcedId' + '}', sourced_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GradingPeriodsManagementApi#get_grading_period\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_grading_periods(opts = {})
      data, _status_code, _headers = get_grading_periods_with_http_info(opts)
      data
    end
    ...
    def get_grading_periods_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GradingPeriodsManagementApi.get_grading_periods ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GradingPeriodsManagementApi#get_grading_periods\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
    # @return [MultipleAcademicSessionsType]
    def get_grading_periods_for_term(term_sourced_id, opts = {})
      data, _status_code, _headers = get_grading_periods_for_term_with_http_info(term_sourced_id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
    # @return [Array<(MultipleAcademicSessionsType, Integer, Hash)>] MultipleAcademicSessionsType data, response status code and response headers
    def get_grading_periods_for_term_with_http_info(term_sourced_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GradingPeriodsManagementApi.get_grading_periods_for_term ...'
      end
      # verify the required parameter 'term_sourced_id' is set
      if @api_client.config.client_side_validation && term_sourced_id.nil?
        fail ArgumentError, "Missing the required parameter 'term_sourced_id' when calling GradingPeriodsManagementApi.get_grading_periods_for_term"
      end
      if @api_client.config.client_side_validation && opts[:'order_by'] && !['acs', 'desc'].include?(opts[:'order_by'])
        fail ArgumentError, 'invalid value for "order_by", must be one of acs, desc'
      end
      # resource path
      local_var_path = '/terms/{termSourcedId}/gradingPeriods'.sub('{' + 'termSourcedId' + '}', term_sourced_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GradingPeriodsManagementApi#get_grading_periods_for_term\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
