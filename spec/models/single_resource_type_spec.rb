...
# Unit tests for SwaggerClient::SingleResourceType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SingleResourceType' do
  before do
    # run before each test
    @instance = SwaggerClient::SingleResourceType.new
  end
  ...
  describe 'test an instance of SingleResourceType' do
    it 'should create an instance of SingleResourceType' do
      expect(@instance).to be_instance_of(SwaggerClient::SingleResourceType)
    end
  end
