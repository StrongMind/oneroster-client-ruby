...
# Unit tests for OneRosterClient::ResourceTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourceTypeAllOf' do
  before do
    # run before each test
    @instance = OneRosterClient::ResourceTypeAllOf.new
  end
  ...
  describe 'test an instance of ResourceTypeAllOf' do
    it 'should create an instance of ResourceTypeAllOf' do
      expect(@instance).to be_instance_of(OneRosterClient::ResourceTypeAllOf)
    end
  end
