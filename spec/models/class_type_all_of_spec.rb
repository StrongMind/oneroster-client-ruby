...
# Unit tests for OneRosterClient::ClassTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClassTypeAllOf' do
  before do
    # run before each test
    @instance = OneRosterClient::ClassTypeAllOf.new
  end
  ...
  describe 'test an instance of ClassTypeAllOf' do
    it 'should create an instance of ClassTypeAllOf' do
      expect(@instance).to be_instance_of(OneRosterClient::ClassTypeAllOf)
    end
  end
