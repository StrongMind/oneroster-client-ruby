...
# Unit tests for OneRosterClient::AcademicSessionsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcademicSessionsManagementApi' do
  before do
    # run before each test
    @instance = OneRosterClient::AcademicSessionsManagementApi.new
  end
  ...
  describe 'test an instance of AcademicSessionsManagementApi' do
    it 'should create an instance of AcademicSessionsManagementApi' do
      expect(@instance).to be_instance_of(OneRosterClient::AcademicSessionsManagementApi)
    end
  end
