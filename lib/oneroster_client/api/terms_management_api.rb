...
module OneRosterClient
  class TermsManagementApi
    ...
    def get_term(sourced_id, opts = {})
      data, _status_code, _headers = get_term_with_http_info(sourced_id, opts)
      data
    end
    ...
    def get_term_with_http_info(sourced_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TermsManagementApi.get_term ...'
      end
      # verify the required parameter 'sourced_id' is set
      if @api_client.config.client_side_validation && sourced_id.nil?
        fail ArgumentError, "Missing the required parameter 'sourced_id' when calling TermsManagementApi.get_term"
      end
      # resource path
      local_var_path = '/terms/{sourcedId}'.sub('{' + 'sourcedId' + '}', sourced_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TermsManagementApi#get_term\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_terms_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TermsManagementApi.get_terms ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TermsManagementApi#get_terms\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
    # @return [MultipleAcademicSessionsType]
    def get_terms_for_school(school_sourced_id, opts = {})
      data, _status_code, _headers = get_terms_for_school_with_http_info(school_sourced_id, opts)
      data
    end
    ...
    # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
    # @return [Array<(MultipleAcademicSessionsType, Integer, Hash)>] MultipleAcademicSessionsType data, response status code and response headers
    def get_terms_for_school_with_http_info(school_sourced_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TermsManagementApi.get_terms_for_school ...'
      end
      # verify the required parameter 'school_sourced_id' is set
      if @api_client.config.client_side_validation && school_sourced_id.nil?
        fail ArgumentError, "Missing the required parameter 'school_sourced_id' when calling TermsManagementApi.get_terms_for_school"
      end
      if @api_client.config.client_side_validation && opts[:'order_by'] && !['acs', 'desc'].include?(opts[:'order_by'])
        fail ArgumentError, 'invalid value for "order_by", must be one of acs, desc'
      end
      # resource path
      local_var_path = '/schools/{schoolSourcedId}/terms'.sub('{' + 'schoolSourcedId' + '}', school_sourced_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TermsManagementApi#get_terms_for_school\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
