...
# Unit tests for SwaggerClient::DemographicType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DemographicType' do
  before do
    # run before each test
    @instance = SwaggerClient::DemographicType.new
  end
  ...
  describe 'test an instance of DemographicType' do
    it 'should create an instance of DemographicType' do
      expect(@instance).to be_instance_of(SwaggerClient::DemographicType)
    end
  end
