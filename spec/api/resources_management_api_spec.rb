...
# Unit tests for SwaggerClient::ResourcesManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResourcesManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ResourcesManagementApi.new
  end
  ...
  describe 'test an instance of ResourcesManagementApi' do
    it 'should create an instance of ResourcesManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ResourcesManagementApi)
    end
  end
