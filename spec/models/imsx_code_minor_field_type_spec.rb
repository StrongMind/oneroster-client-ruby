...
# Unit tests for SwaggerClient::ImsxCodeMinorFieldType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImsxCodeMinorFieldType' do
  before do
    # run before each test
    @instance = SwaggerClient::ImsxCodeMinorFieldType.new
  end
  ...
  describe 'test an instance of ImsxCodeMinorFieldType' do
    it 'should create an instance of ImsxCodeMinorFieldType' do
      expect(@instance).to be_instance_of(SwaggerClient::ImsxCodeMinorFieldType)
    end
  end
