...
# Unit tests for SwaggerClient::TeachersManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeachersManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::TeachersManagementApi.new
  end
  ...
  describe 'test an instance of TeachersManagementApi' do
    it 'should create an instance of TeachersManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::TeachersManagementApi)
    end
  end
