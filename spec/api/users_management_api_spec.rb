...
# Unit tests for OneRosterClient::UsersManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UsersManagementApi' do
  before do
    # run before each test
    @instance = OneRosterClient::UsersManagementApi.new
  end
  ...
  describe 'test an instance of UsersManagementApi' do
    it 'should create an instance of UsersManagementApi' do
      expect(@instance).to be_instance_of(OneRosterClient::UsersManagementApi)
    end
  end
