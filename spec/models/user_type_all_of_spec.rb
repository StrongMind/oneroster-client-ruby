...
# Unit tests for OneRosterClient::UserTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserTypeAllOf' do
  before do
    # run before each test
    @instance = OneRosterClient::UserTypeAllOf.new
  end
  ...
  describe 'test an instance of UserTypeAllOf' do
    it 'should create an instance of UserTypeAllOf' do
      expect(@instance).to be_instance_of(OneRosterClient::UserTypeAllOf)
    end
  end
