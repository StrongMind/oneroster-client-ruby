...
module OneRosterClient
  class DemographicsManagementApi
    ...
    def get_demographic(sourced_id, opts = {})
      data, _status_code, _headers = get_demographic_with_http_info(sourced_id, opts)
      data
    end
    ...
    # @param sourced_id ...tbd...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SingleDemographicsType, Integer, Hash)>] SingleDemographicsType data, response status code and response headers
    def get_demographic_with_http_info(sourced_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DemographicsManagementApi.get_demographic ...'
      end
      # verify the required parameter 'sourced_id' is set
      if @api_client.config.client_side_validation && sourced_id.nil?
        fail ArgumentError, "Missing the required parameter 'sourced_id' when calling DemographicsManagementApi.get_demographic"
      end
      # resource path
      local_var_path = '/demographics/{sourcedId}'.sub('{' + 'sourcedId' + '}', sourced_id.to_s)
      ...
      return_type = opts[:return_type] || 'SingleDemographicsType' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DemographicsManagementApi#get_demographic\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_demographics(opts = {})
      data, _status_code, _headers = get_demographics_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :filter The filtering rules to be applied when identifying the records to be supplied in the response message.
    # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
    # @return [Array<(DemographicsType, Integer, Hash)>] DemographicsType data, response status code and response headers
    def get_demographics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DemographicsManagementApi.get_demographics ...'
      end
      ...
      return_type = opts[:return_type] || 'DemographicsType' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DemographicsManagementApi#get_demographics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
