...
# Unit tests for SwaggerClient::DemographicTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DemographicTypeAllOf' do
  before do
    # run before each test
    @instance = SwaggerClient::DemographicTypeAllOf.new
  end
  ...
  describe 'test an instance of DemographicTypeAllOf' do
    it 'should create an instance of DemographicTypeAllOf' do
      expect(@instance).to be_instance_of(SwaggerClient::DemographicTypeAllOf)
    end
  end
