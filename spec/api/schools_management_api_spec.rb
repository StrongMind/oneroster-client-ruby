...
# Unit tests for SwaggerClient::SchoolsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SchoolsManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::SchoolsManagementApi.new
  end
  ...
  describe 'test an instance of SchoolsManagementApi' do
    it 'should create an instance of SchoolsManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::SchoolsManagementApi)
    end
  end
