...
# Unit tests for SwaggerClient::AcademicSessionType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcademicSessionType' do
  before do
    # run before each test
    @instance = SwaggerClient::AcademicSessionType.new
  end
  ...
  describe 'test an instance of AcademicSessionType' do
    it 'should create an instance of AcademicSessionType' do
      expect(@instance).to be_instance_of(SwaggerClient::AcademicSessionType)
    end
  end
