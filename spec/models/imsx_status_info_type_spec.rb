...
# Unit tests for SwaggerClient::ImsxStatusInfoType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImsxStatusInfoType' do
  before do
    # run before each test
    @instance = SwaggerClient::ImsxStatusInfoType.new
  end
  ...
  describe 'test an instance of ImsxStatusInfoType' do
    it 'should create an instance of ImsxStatusInfoType' do
      expect(@instance).to be_instance_of(SwaggerClient::ImsxStatusInfoType)
    end
  end
