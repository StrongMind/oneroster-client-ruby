...
# Unit tests for SwaggerClient::ClassesManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClassesManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ClassesManagementApi.new
  end
  ...
  describe 'test an instance of ClassesManagementApi' do
    it 'should create an instance of ClassesManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ClassesManagementApi)
    end
  end
