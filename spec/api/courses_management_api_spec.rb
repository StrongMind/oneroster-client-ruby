...
# Unit tests for OneRosterClient::CoursesManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoursesManagementApi' do
  before do
    # run before each test
    @instance = OneRosterClient::CoursesManagementApi.new
  end
  ...
  describe 'test an instance of CoursesManagementApi' do
    it 'should create an instance of CoursesManagementApi' do
      expect(@instance).to be_instance_of(OneRosterClient::CoursesManagementApi)
    end
  end
