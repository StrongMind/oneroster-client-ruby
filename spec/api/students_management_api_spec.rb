...
# Unit tests for SwaggerClient::StudentsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StudentsManagementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::StudentsManagementApi.new
  end
  ...
  describe 'test an instance of StudentsManagementApi' do
    it 'should create an instance of StudentsManagementApi' do
      expect(@instance).to be_instance_of(SwaggerClient::StudentsManagementApi)
    end
  end
