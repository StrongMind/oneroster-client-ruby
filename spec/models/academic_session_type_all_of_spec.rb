...
# Unit tests for SwaggerClient::AcademicSessionTypeAllOf
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AcademicSessionTypeAllOf' do
  before do
    # run before each test
    @instance = SwaggerClient::AcademicSessionTypeAllOf.new
  end
  ...
  describe 'test an instance of AcademicSessionTypeAllOf' do
    it 'should create an instance of AcademicSessionTypeAllOf' do
      expect(@instance).to be_instance_of(SwaggerClient::AcademicSessionTypeAllOf)
    end
  end
