...
# Unit tests for OneRosterClient::TeachersManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TeachersManagementApi' do
  before do
    # run before each test
    @instance = OneRosterClient::TeachersManagementApi.new
  end
  ...
  describe 'test an instance of TeachersManagementApi' do
    it 'should create an instance of TeachersManagementApi' do
      expect(@instance).to be_instance_of(OneRosterClient::TeachersManagementApi)
    end
  end
  ...
  # unit tests for get_teachers_for_class
  ...
  # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
  # @return [UsersType]
  describe 'get_teachers_for_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_teachers_for_class_in_school
  ...
  # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
  # @return [UsersType]
  describe 'get_teachers_for_class_in_school test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
