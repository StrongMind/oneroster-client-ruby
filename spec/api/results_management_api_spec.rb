...
# Unit tests for OneRosterClient::ResultsManagementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResultsManagementApi' do
  before do
    # run before each test
    @instance = OneRosterClient::ResultsManagementApi.new
  end
  ...
  describe 'test an instance of ResultsManagementApi' do
    it 'should create an instance of ResultsManagementApi' do
      expect(@instance).to be_instance_of(OneRosterClient::ResultsManagementApi)
    end
  end

  # unit tests for delete_result
  # The REST delete request message for the deleteResult() API call.
  # ...not supplied...
  # @param sourced_id ...tbd...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_result test' do
    it 'should work' do
  ...
  # @return [ResultsType]
  describe 'get_results test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_results_for_class
  ...
  # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
  # @return [ResultsType]
  describe 'get_results_for_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_results_for_line_item_for_class
  ...
  # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
  # @return [ResultsType]
  describe 'get_results_for_line_item_for_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_results_for_student_for_class
  ...
  # @option opts [Array<String>] :fields To identify the range of fields that should be supplied in the response message.
  # @return [ResultsType]
  describe 'get_results_for_student_for_class test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_result
