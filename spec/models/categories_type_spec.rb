...
# Unit tests for SwaggerClient::CategoriesType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CategoriesType' do
  before do
    # run before each test
    @instance = SwaggerClient::CategoriesType.new
  end
  ...
  describe 'test an instance of CategoriesType' do
    it 'should create an instance of CategoriesType' do
      expect(@instance).to be_instance_of(SwaggerClient::CategoriesType)
    end
  end
